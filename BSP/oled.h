...
#define OLED_SDIN_Clr()     HAL_GPIO_WritePin(OLED_DI_GPIO_Port,OLED_DI_Pin,GPIO_PIN_RESET)//DIN
#define OLED_SDIN_Set()     HAL_GPIO_WritePin(OLED_DI_GPIO_Port,OLED_DI_Pin,GPIO_PIN_SET)
typedef enum
{
    Pen_Clear = 0x00,
    Pen_Write = 0x01,
